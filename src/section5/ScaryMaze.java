...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("scary-maze-pixilart.png"));
	...
	private void scare() {
		System.out.println("RUN DUNUNUNUNUNUNUNUNUUNU DUNUNUNUNUNUNUNU DUNUNUNUNUNUNU!");
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Sound Effect Run.mp3"));
